...
root.maxsize(1500, 1500)  # specify the max size the window can expand to
...
image = PhotoImage(file="sample.png")
...
image_gif = PhotoImage(file="giphy.gif")
display_image = image_gif.subsample(1, 1)
Label(right_frame, image=display_image).grid(row=0, column=0, padx=5, pady=5)

# Create tool bar frame
tool_bar = Frame(left_frame, width=180, height=185)
tool_bar.grid(row=2, column=0, padx=5, pady=5)

# Example labels that serve as placeholder for other widgets
